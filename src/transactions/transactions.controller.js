...
var TransactionsController = /** @class */ (function () {
    ...
    TransactionsController.prototype.getIssue = function (request) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transactionsService.getMyTransactions({
                                userId: user.id
                            })];
                    case 1:
                        data = _a.sent();
    ...
    ], TransactionsController.prototype, "getIssue");
